...
class Router {
    ...
    function __construct() {
        ...
        $this->add('',['controller'=>'user', 'action'=>'login']);
        $this->add('{controller}/{action}');
        $this->add('{namespace}/{controller}/{action}');
        $this->add('{namespace}/{controller}/{id:\d+}/{action}');
        $this->add('{namespace}', ['namespace' => '', 'controller' => 'Home']);
        $this->add('{namespace}/', ['namespace' => '', 'controller' => 'Home']);
    }
