...
<div>
    ...
    ?>
    <table>
        <caption>Your Account Information</caption>
        <?php
            $tableDataAccount = fetchRow('customers', ['custId' => $id]);
            echo printRowKey($tableDataAccount);
            $tableDataAccount = fetchRow('customers', ['custId' => $id]);
            echo printRowValue($tableDataAccount); 
        ?>
    </table>
    <table>
        <caption>Your Address Information</caption>
        <?php
            $tableDataAccount = fetchRow('customer_address', ['custId' => $id]);
            echo printRowKey($tableDataAccount);
            $tableDataAccount = fetchRow('customer_address', ['custId' => $id]);
            echo printRowValue($tableDataAccount); 
        ?>
    ...
    <table>
        <caption>Your Other Information</caption>
        <?php
            $tableDataAccount = fetchRow('customer_additional_info', ['custId' => $id]);
            echo printRowKey($tableDataAccount);
            $tableDataAccount = fetchRow('customer_additional_info', ['custId' => $id]);
            echo printRowValue($tableDataAccount); 
        ?>
